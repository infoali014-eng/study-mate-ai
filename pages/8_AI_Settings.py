...
page_header(
    "AI Settings",
    "Connect Gemini API securely without exposing your API key.",
...
with feature1:
    render_feature_card(
        "User-owned keys",
        "Each visitor can save their own Gemini key securely.",
        "\u2728",
        "#14b8b4",
        "#d8fff6",
    )
with feature2:
    render_feature_card(
        "Gemini chat",
        "Use Gemini for chat, tutoring, quizzes, graphs, and planning.",
        "\U0001f916",
        "#2f7df6",
        "#e3efff",
    )
with feature3:
    render_feature_card(
        "Local or Demo",
        "Keep secure Gemini settings simple for every student.",
        "\U0001f9ea",
        "#ffb703",
        "#fff3c4",
    )
